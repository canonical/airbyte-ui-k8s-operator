            ...
            "services": {
                APP_NAME: {
                    ...
                    "environment": {
                        ...
                        "PORT": 8080,
                        "REACT_APP_API_URL": f"airbyte-k8s:{INTERNAL_API_PORT}/api",
                        "REACT_APP_CONNECTOR_BUILDER_API_URL": f"airbyte-k8s:{CONNECTOR_BUILDER_API_PORT}/connector-builder-api",
                    },
